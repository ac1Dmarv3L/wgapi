...
<!--Big Sidebar Search-->
<nav class="wotinfo flex flex-grow mt-4 -mx-3 space-y-6">
    ...
    <div class="text-left">
        ...
        <div class="w-56">
            <a class="flex items-center px-3 py-2 text-sm text-gray-500 transition-colors duration-300 transform rounded-lg
                        ...
                        uppercase"
               href="#" id="wot-menu-button" aria-expanded="true" aria-haspopup="true">
                <svg class="-mr-1 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                </svg>

                <span class="mx-2 text-sm font-medium">user search in WOT</span>
            </a>
        </div>
        <!--Test Sidebar Link-->

        <div class="hidden z-10 mt-2 w-56 origin-top-right shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
             id="wot-dropdown-menu" role="menu" aria-orientation="vertical" aria-labelledby="menu-button"
             tabindex="-1">
            <!--Search Form-->
