...
<!--Big Sidebar Search-->
<nav class="wotbinfo hidden flex-grow mt-4 -mx-3 space-y-6">
    ...
    <div class="text-left">
        ...
        <!--Test Sidebar Link-->
        <div class="w-56">
            <a class="flex items-center px-3 py-2 text-sm text-gray-500 transition-colors duration-300 transform rounded-lg
                        dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700
                        uppercase"
               href="#" id="wotb-menu-button" aria-expanded="true" aria-haspopup="true">
                <svg class="-mr-1 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                </svg>

                <span class="mx-2 text-sm font-medium">user search in WOTB</span>
            </a>
        </div>
        <!--Test Sidebar Link-->

        <div class="hidden z-10 mt-2 w-56 origin-top-right shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
             id="wotb-dropdown-menu" role="menu" aria-orientation="vertical" aria-labelledby="menu-button"
             tabindex="-1">
            <!--Search Form-->
